...
#define PERIPH_L4_FAST_PA        PLATFORM_PERIPH_L4_FAST_PA
#define PERIPH_L4_FAST_SECTIONS  PLATFORM_PERIPH_L4_FAST_SECTIONS
#define PERIPH_USBSS_PA          PLATFORM_PERIPH_USBSS_PA
#define PERIPH_USBSS_SECTIONS    PLATFORM_PERIPH_USBSS_SECTIONS
