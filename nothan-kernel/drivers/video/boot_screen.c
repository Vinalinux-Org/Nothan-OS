...
static void show_boot_log(void)
{
    ...
    /* Title */
    fb_puts(cx, cy, "NothanOS Boot", title_col, bg);
    cy += line_h + 8;
...
static void show_splash(void)
{
    ...
    fb_puts_scaled(tx, ty, "NOTHAN OS", FB_WHITE, bg, scale);
 ...
 *
 * Layout (800x600):
 *   Status bar  y=0..43    clock | NOTHAN OS | wifi + battery
