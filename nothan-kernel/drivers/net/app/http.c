...
static void generate_html(void)
{
    ap("<!DOCTYPE html><html lang=en><head>"
       ...
       "<title>NothanOS &#8212; Vinalinux</title>"
       "<style>"
       ":root{"
    ...
    ap("<header class=topbar>"
       ...
       "<div class=brand-row1><span class=brand-name>NothanOS</span><span class=brand-ver>v1.0.0</span></div>"
    ...
    ap("<section class='bot-row mt16'>"
       ...
       "<tr><td>Product</td><td>NothanOS v1.0.0</td></tr>"
       ...
       "<span class=fn>You are viewing this dashboard live &#8212; "
           "served directly from <em>NothanOS</em> running on the embedded device</span>"
       "<span class=fn-copy style='color:var(--t3);font-size:10.5px;font-family:var(--mono)'>"
           "&copy; Vinalinux &middot; NothanOS v1.0.0</span>"
       "</footer></div>");
