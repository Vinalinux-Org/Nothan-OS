...
| Boot ROM | 0x4002_0000 | 0x4002_BFFF | 48 KB | 32-bit Ex/R(2) – Public |
...
| SRAM internal | 0x402F_0400 | 0x402F_FFFF | 64 KB | 32-bit Ex/R/W(2) |
...
| USB0 | 0x4740_1000 | 0x4740_12FF | 32 KB | USB0 Controller Registers |
| USB0_PHY | 0x4740_1300 | 0x4740_13FF | 32 KB | USB0 PHY Registers |
| USB0 Core | 0x4740_1400 | 0x4740_17FF | 32 KB | USB0 Core Registers |
| USB1 | 0x4740_1800 | 0x4740_1AFF | 32 KB | USB1 Controller Registers |
| USB1_PHY | 0x4740_1B00 | 0x4740_1BFF | 32 KB | USB1 PHY Registers |
| USB1 Core | 0x4740_1C00 | 0x4740_1FFF | 32 KB | USB1 Core Registers |
| USB CPPI DMA Controller | 0x4740_2000 | 0x4740_2FFF | 32 KB | USB CPPI DMA Controller Registers |
| USB CPPI DMA Scheduler | 0x4740_3000 | 0x4740_3FFF | 32 KB | USB CPPI DMA Scheduler Registers |
| USB Queue Manager | 0x4740_4000 | 0x4740_7FFF | 32 KB | USB Queue Manager Registers |
...
| L4_PER | 0x4800_0000 | 0x48FF_FFFF | 16 MB | L4 Peripheral (see L4_PER table) |
...
| TPTC0 (EDMA3TC0) | 0x4980_0000 | 0x498F_FFFF | 1 MB | EDMA3 Transfer Controller 0 Registers |
| TPTC1 (EDMA3TC1) | 0x4990_0000 | 0x499F_FFFF | 1 MB | EDMA3 Transfer Controller 1 Registers |
| TPTC2 (EDMA3TC2) | 0x49A0_0000 | 0x49AF_FFFF | 1 MB | EDMA3 Transfer Controller 2 Registers |
...
| DebugSS_ETM | 0x4B14_0000 | 0x4B14_0FFF | 4 KB | CortexA8 ETM Unit |
| DebugSS_Debug | 0x4B14_1000 | 0x4B14_1FFF | 4 KB | CortexA8 Debug Unit |
| DebugSS_CTI | 0x4B14_2000 | 0x4B14_2FFF | 4 KB | CortexA8 CTI Unit |
| DebugSS_ICE | 0x4B14_3000 | 0x4B14_3FFF | 4 KB | ICECrusherCS APB |
| Reserved | 0x4B14_4000 | 0x4B15_FFFF | 128 KB | Reserved |
| DebugSS_DRM | 0x4B16_0000 | 0x4B16_0FFF | 4 KB | Debug Subsystem: Debug Resource Manager |
| DebugSS_ETB | 0x4B16_2000 | 0x4B16_2FFF | 4 KB | Debug Subsystem: Embedded Trace Buffer |
| Reserved | 0x4B16_3000 | 0x4BFF_FFFF | 15 MB-396 KB | Reserved |
| EMIF0 | 0x4C00_0000 | 0x4CFF_FFFF | 16 MB | EMIF0 Configuration registers |
| Reserved | 0x4D00_0000 | 0x4DFF_FFFF | 16 MB | Reserved |
| Reserved | 0x4E00_0000 | 0x4FFF_FFFF | 32 MB | Reserved |
| GPMC | 0x5000_0000 | 0x50FF_FFFF | 16 MB | GPMC Configuration registers |
| Reserved | 0x5100_0000 | 0x52FF_FFFF | 32 MB | Reserved |
| Reserved | 0x5300_0000 | 0x530F_FFFF | 1 MB | Reserved |
| Reserved | 0x5310_0000 | 0x531F_FFFF | 1 MB | Reserved |
...
| Block Name | Start_address(hex) | End_address(hex) | Size | Description |
| --- | --- | --- | --- | --- |
| Reserved | 0x5350_0000 | 0x535F_FFFF | 1 MB | Reserved |
| Reserved | 0x5360_0000 | 0x54BF_FFFF | 22 MB | Reserved |
| ADC_TSC DMA | 0x54C0_0000 | 0x54FF_FFFF | 4 MB | ADC_TSC DMA Port |
...
| EMIF0 SDRAM | 0x8000_0000 | 0xBFFF_FFFF | 1 GB | 8-/16-bit External Memory (Ex/R/W)(2) |
...
| --- | --- | --- | --- | --- |
| L4_WKUP configuration | 0x44C0_0000 | 0x44C0_07FF | 2 KB | Address/Protection (AP) |
| L4_WKUP configuration | 0x44C0_0800 | 0x44C0_0FFF | 2 KB | Link Agent (LA) |
| L4_WKUP configuration | 0x44C0_1000 | 0x44C0_13FF | 1 KB | Initiator Port (IP0) |
| L4_WKUP configuration | 0x44C0_1400 | 0x44C0_17FF | 1 KB | Initiator Port (IP1) |
...
| Reserved | 0x44E0_4000 | 0x44E0_4FFF | 4 KB | Reserved |
| DMTIMER0 | 0x44E0_5000 | 0x44E0_5FFF | 4 KB | DMTimer0 Registers |
| Reserved | 0x44E0_6000 | 0x44E0_6FFF | 4 KB | Reserved |
| GPIO0 | 0x44E0_7000 | 0x44E0_7FFF | 4 KB | GPIO Registers |
| Reserved | 0x44E0_8000 | 0x44E0_8FFF | 4 KB | Reserved |
| UART0 | 0x44E0_9000 | 0x44E0_9FFF | 4 KB | UART Registers |
| Reserved | 0x44E0_A000 | 0x44E0_AFFF | 4 KB | Reserved |
| I2C0 | 0x44E0_B000 | 0x44E0_BFFF | 4 KB | I2C Registers |
| Reserved | 0x44E0_C000 | 0x44E0_CFFF | 4 KB | Reserved |
| ADC_TSC | 0x44E0_D000 | 0x44E0_EFFF | 8 KB | ADC_TSC Registers |
| Reserved | 0x44E0_F000 | 0x44E0_FFFF | 4 KB | Reserved |
| Control Module | 0x44E1_0000 | 0x44E1_1FFF | 128 KB | Control Module Registers |
| DDR2/3/mDDR PHY | 0x44E1_2000 | 0x44E1_23FF | 128 KB | DDR2/3/mDDR PHY Registers |
| Reserved | 0x44E1_2400 | 0x44E3_0FFF | 4 KB | Reserved |
| DMTIMER1_1MS (Accurate 1ms timer) | 0x44E3_1000 | 0x44E3_1FFF | 4 KB | DMTimer1 1ms Registers |
| Reserved | 0x44E3_2000 | 0x44E3_2FFF | 4 KB | Reserved |
| Reserved | 0x44E3_3000 | 0x44E3_3FFF | 4 KB | Reserved |
| Reserved | 0x44E3_4000 | 0x44E3_4FFF | 4 KB | Reserved |
| WDT1 | 0x44E3_5000 | 0x44E3_5FFF | 4 KB | Watchdog Timer Registers |
| Reserved | 0x44E3_6000 | 0x44E3_6FFF | 4 KB | Reserved |
| SmartReflex0 | 0x44E3_7000 | 0x44E3_7FFF | 4 KB | L3 Registers |
| Reserved | 0x44E3_8000 | 0x44E3_8FFF | 4 KB | Reserved |
| SmartReflex1 | 0x44E3_9000 | 0x44E3_9FFF | 4 KB | L3 Registers |
| Reserved | 0x44E3_A000 | 0x44E3_AFFF | 4 KB | Reserved |
| Reserved | 0x44E3_B000 | 0x44E3_DFFF | 12 KB | Reserved |
| RTCSS | 0x44E3_E000 | 0x44E3_EFFF | 4 KB | RTC Registers |
| Reserved | 0x44E3_F000 | 0x44E3_FFFF | 4 KB | Reserved |
| DebugSS Instrumentation HWMaster1 Port | 0x44E4_0000 | 0x44E7_FFFF | 256 KB | Debug Registers |
| Reserved | 0x44E8_0000 | 0x44E8_0FFF | 4 KB | Reserved |
...
| Reserved | 0x4800_0800 | 0x4800_0FFF | 2 KB | Reserved |
| Reserved | 0x4800_1000 | 0x4800_13FF | 1 KB | Reserved |
...
| Device Name | Start_address(hex) | End_address(hex) | Size | Description |
| --- | --- | --- | --- | --- |
| Reserved | 0x4800_1400 | 0x4800_17FF | 1 KB | Reserved |
| Reserved | 0x4800_1800 | 0x4800_1BFF | 1 KB | Reserved |
| Reserved | 0x4800_1C00 | 0x4800_1FFF | 1 KB | Reserved |
...
| Reserved | 0x4802_1000 | 0x4802_1FFF | 4 KB | Reserved |
| UART1 | 0x4802_2000 | 0x4802_2FFF | 4 KB | UART1 Registers |
| Reserved | 0x4802_3000 | 0x4802_3FFF | 4 KB | Reserved |
| UART2 | 0x4802_4000 | 0x4802_4FFF | 4 KB | UART2 Registers |
| Reserved | 0x4802_5000 | 0x4802_5FFF | 4 KB | Reserved |
| Reserved | 0x4802_6000 | 0x4802_7FFF | 8 KB | Reserved |
| Reserved | 0x4802_8000 | 0x4802_8FFF | 4 KB | Reserved |
| Reserved | 0x4802_9000 | 0x4802_9FFF | 4 KB | Reserved |
| I2C1 | 0x4802_A000 | 0x4802_AFFF | 4 KB | I2C1 Registers |
| Reserved | 0x4802_B000 | 0x4802_BFFF | 4 KB | Reserved |
| Reserved | 0x4802_C000 | 0x4802_CFFF | 4 KB | Reserved |
| Reserved | 0x4802_D000 | 0x4802_DFFF | 4 KB | Reserved |
| Reserved | 0x4802_E000 | 0x4802_EFFF | 4 KB | Reserved |
| Reserved | 0x4802_F000 | 0x4802_FFFF | 4 KB | Reserved |
| McSPI0 | 0x4803_0000 | 0x4803_0FFF | 4 KB | McSPI0 Registers |
| Reserved | 0x4803_1000 | 0x4803_1FFF | 4 KB | Reserved |
| Reserved | 0x4803_2000 | 0x4803_2FFF | 4 KB | Reserved |
| Reserved | 0x4803_3000 | 0x4803_3FFF | 4 KB | Reserved |
| Reserved | 0x4803_4000 | 0x4803_4FFF | 4 KB | Reserved |
| Reserved | 0x4803_5000 | 0x4803_5FFF | 4 KB | Reserved |
| Reserved | 0x4803_6000 | 0x4803_6FFF | 4 KB | Reserved |
| Reserved | 0x4803_7000 | 0x4803_7FFF | 4 KB | Reserved |
| McASP0 CFG | 0x4803_8000 | 0x4803_9FFF | 8 KB | McASP0 CFG Registers |
| Reserved | 0x4803_A000 | 0x4803_AFFF | 4 KB | Reserved |
| Reserved | 0x4803_B000 | 0x4803_BFFF | 4 KB | Reserved |
| McASP1 CFG | 0x4803_C000 | 0x4803_DFFF | 8 KB | McASP1 CFG Registers |
| Reserved | 0x4803_E000 | 0x4803_EFFF | 4 KB | Reserved |
| Reserved | 0x4803_F000 | 0x4803_FFFF | 4 KB | Reserved |
| DMTIMER2 | 0x4804_0000 | 0x4804_0FFF | 4 KB | DMTimer2 Registers |
| Reserved | 0x4804_1000 | 0x4804_1FFF | 4 KB | Reserved |
| DMTIMER3 | 0x4804_2000 | 0x4804_2FFF | 4 KB | DMTimer3 Registers |
| Reserved | 0x4804_3000 | 0x4804_3FFF | 4 KB | Reserved |
| DMTIMER4 | 0x4804_4000 | 0x4804_4FFF | 4 KB | DMTimer4 Registers |
| Reserved | 0x4804_5000 | 0x4804_5FFF | 4 KB | Reserved |
...
| Device Name | Start_address(hex) | End_address(hex) | Size | Description |
| --- | --- | --- | --- | --- |
| DMTIMER5 | 0x4804_6000 | 0x4804_6FFF | 4 KB | DMTimer5 Registers |
| Reserved | 0x4804_7000 | 0x4804_7FFF | 4 KB | Reserved |
| DMTIMER6 | 0x4804_8000 | 0x4804_8FFF | 4 KB | DMTimer6 Registers |
| DMTIMER6 | 0x4804_9000 | 0x4804_9FFF | 4 KB | L4 Interconnect |
| DMTIMER7 | 0x4804_A000 | 0x4804_AFFF | 4 KB | DMTimer7 Registers |
| Reserved | 0x4804_B000 | 0x4804_BFFF | 4 KB | Reserved |
| GPIO1 | 0x4804_C000 | 0x4804_CFFF | 4 KB | GPIO1 Registers |
| Reserved | 0x4804_D000 | 0x4804_DFFF | 4 KB | Reserved |
...
| PWM Subsystem 0 | 0x4830_0000 | 0x4830_00FF | 4 KB | PWMSS0 Configuration Registers |
| eCAP0 | 0x4830_0100 | 0x4830_017F | 4 KB | PWMSS eCAP0 Registers |
| eQEP0 | 0x4830_0180 | 0x4830_01FF | 4 KB | PWMSS eQEP0 Registers |
| ePWM0 | 0x4830_0200 | 0x4830_025F | 4 KB | PWMSS ePWM0 Registers |
| Reserved | 0x4830_0260 | 0x4830_1FFF | 4 KB | Reserved |
| PWM Subsystem 1 | 0x4830_2000 | 0x4830_20FF | 4 KB | PWMSS1 Configuration Registers |
| eCAP1 | 0x4830_2100 | 0x4830_217F | 4 KB | PWMSS eCAP1 Registers |
| eQEP1 | 0x4830_2180 | 0x4830_21FF | 4 KB | PWMSS eQEP1 Registers |
| ePWM1 | 0x4830_2200 | 0x4830_225F | 4 KB | PWMSS ePWM1 Registers |
| Reserved | 0x4830_2260 | 0x4830_3FFF | 4 KB | Reserved |
| PWM Subsystem 2 | 0x4830_4000 | 0x4830_40FF | 4 KB | PWMSS2 Configuration Registers |
| eCAP2 | 0x4830_4100 | 0x4830_417F | 4 KB | PWMSS eCAP2 Registers |
| eQEP2 | 0x4830_4180 | 0x4830_41FF | 4 KB | PWMSS eQEP2 Registers |
| ePWM2 | 0x4830_4200 | 0x4830_425F | 4 KB | PWMSS ePWM2 Registers |
| Reserved | 0x4830_4260 | 0x4830_5FFF | 4 KB | Reserved |
| Reserved | 0x4830_6000 | 0x4830_DFFF | 32 KB | Reserved |
| LCD Controller | 0x4830_E000 | 0x4830_EFFF | 4 KB | LCD Registers |
| Reserved | 0x4830_F000 | 0x4830_FFFF | 4 KB | Reserved |
| Reserved | 0x4831_0000 | 0x4831_1FFF | 8 KB | Reserved |
| Reserved | 0x4831_2000 | 0x4831_2FFF | 4 KB | Reserved |
| Reserved | 0x4831_3000 | 0x4831_7FFF | 20 KB | Reserved |
| Reserved | 0x4831_8000 | 0x4831_BFFF | 16 KB | Reserved |
| Reserved | 0x4831_C000 | 0x4831_CFFF | 4 KB | Reserved |
...
| L4_Fast configuration | 0x4A00_0800 | 0x4A00_0FFF | 2 KB | Link Agent (LA) |
| L4_Fast configuration | 0x4A00_1000 | 0x4A00_13FF | 1 KB | Initiator Port (IP0) |
| Reserved | 0x4A00_1400 | 0x4A00_17FF | 1 KB | Reserved |
| Reserved | 0x4A00_1800 | 0x4A00_1FFF | 2 KB | Reserved (IP2 – IP3) |
| Reserved | 0x4A00_2000 | 0x4A07_FFFF | 504 KB | Reserved |
| Reserved | 0x4A08_0000 | 0x4A09_FFFF | 128 KB | Reserved |
| Reserved | 0x4A0A_0000 | 0x4A0A_0FFF | 4 KB | Reserved |
...
| Reserved | 0x4A15_0000 | 0x4A15_0FFF | 4 KB | Reserved |
...
| Reserved | 0x4A38_0000 | 0x4A38_0FFF | 4 KB | Reserved |
