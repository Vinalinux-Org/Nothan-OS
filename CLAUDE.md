...
**Trước mỗi module mới: trao đổi thiết kế với dev trước, không tự ý bắt đầu code.**

Giải thích cấu trúc, các thành phần cần làm, trade-off — để dev hiểu và quyết định hướng đi. Dev là người quyết định, không phải Claude.
